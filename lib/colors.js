...
export function blue(str) { // BRIGHT_CYAN
  return ANSI_COLORS.BRIGHT_CYAN + str + ANSI_COLORS.DEFAULT;
}
...
export function color(str, color = null, configColors = true) {
  if (!configColors || !color) return str;
  return COLORS_MAP[color](str);
}
